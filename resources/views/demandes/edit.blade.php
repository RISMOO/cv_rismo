...
<div class="form-group">
   ...
   <h6>{{ Form::text('Labs',$demande->Labs,['class'=>'form-control border font-weight-bolder text-primary','placeholder'=>'le nom de votre labs'])}}</h6>
</div>
...
<div class="form-group">
    ...
    <h6>{{Form::select('ressource',$ressources,$demande->ressource['id'],['class'=>'custom-select font-weight-bolder  text-primary border','placeholder'=>'ressources'])}}</h6>



<div class="form-group">
    <h5 class="text-light">{{ Form::label('Date de début','Date de début ')}}</h5>
   <h6> {{ Form::date('Date_de_debut',$demande->Date_de_debut,['class'=>'form-control font-weight-bolder text-primary border'])}}</h6>
</div>


<div class="form-group">
    <h5 class="text-light">{{ Form::label('Date de fin','Date de fin ')}}</h5>
   <h6> {{ Form::date('Date_de_fin',$demande->Date_de_fin,['class'=>'form-control font-weight-bolder text-primary border'])}}</h6>
</div>
